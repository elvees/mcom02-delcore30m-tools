...
class TestcaseDSP(unittest.TestCase):
    ...
    def test_paralleltest1core(self):
        ...
        cores = 1
        for _ in range(100):
            self.exec_command("delcore30m-paralleltest", str(threadnum),
                              str(cores))
    ...
    def test_dma1core(self):
        ...
        for _ in range(cycles):
            self.exec_command("delcore30m-inversiontest",
                              "-i", self.images[1])
    ...
    def test_dma2core_async(self):
        ...
        for core, cycle in enumerate(cycles):
            thread = Thread(target=lambda q, arg1, arg2: q.put(process(arg1, arg2)),
