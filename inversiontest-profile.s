...
;
;
; Inverse input image on ELcore-30M with debug
;
...
inversiontest_interrupt:
;-----save context---
	move R0.l, R20.l
	move 2, R0.l
	js _write_debug_info_interrupt
...
_write_debug_info_interrupt:
	move R0.l, (A5)+
	move 0x3700100C, R0.l
	lsrl 0x2, R0.l
	move R0.l, A3
	move (A3), R0.l
	move R0.l, (A5)+
